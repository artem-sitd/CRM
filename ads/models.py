...
class Ads(models.Model):
    ...
    promotion_choice = (
        ('INSTAGRAM', 'INSTAGRAM'), ('YOUTUBE', 'YOUTUBE'), ('2GIS', '2GIS'), ('GOOGLE', 'GOOGLE'),
        ('YANDEX', 'YANDEX'), ('SITE', 'SITE'), ('AVITO', 'AVITO'), ('VK_GROUP', 'VK_GROUP'),
        ('VK_ADS', 'VK_ADS'), ('TG_CHANNEL', 'TG_CHANNEL'), ('TG_ADS', 'TG_ADS'), ('other', 'other'))
