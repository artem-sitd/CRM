...
class Contract(models.Model):
    ...
    file = models.FileField(null=True, upload_to='contracts/file', blank=True)  # Договор, или другой файл
    ads_history = models.ForeignKey(HistoryAds, on_delete=models.SET_NULL,
                                    null=True)  # расскомментить после миграция рекламы
