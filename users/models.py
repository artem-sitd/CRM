...
class Profile(models.Model):
    ...
    fired = models.BooleanField(default=False, null=True, blank=True)  # Для сотрудников. Если True - уволен
    ...
    def __str__(self: 'object of class Client') -> str:
        return f"Имя: {self.name}, Фамилия: {self.second_name}, Отчество: {self.surname}"
